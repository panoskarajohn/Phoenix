...
namespace Community.Rabbit.Initializers;
...
public class RabbitMqExchangeInitializer : IInitializer
{
    ...
    public Task InitAsync()
    {
        var exchanges = AppDomain.CurrentDomain
            ...
            .Where(t => t.IsDefined(typeof(RabbitMessageAttribute), false))
            .Select(t => t.GetCustomAttribute<RabbitMessageAttribute>().Exchange)
            .Distinct()
            .ToList();
